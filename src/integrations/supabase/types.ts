...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      lead_status: "nuevo" | "contactado" | "interesado" | "cerrado" | "descartado";
      listing_type: "venta" | "arriendo";
      post_category:
        "compra" | "venta" | "inversion" | "consejos" | "mercado" | "legal" | "proyectos";
      post_status: "borrador" | "publicado" | "programado";
      property_status: "disponible" | "vendido" | "arrendado" | "reservado";
      property_type: "apartamento" | "casa" | "local" | "oficina" | "lote" | "bodega";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      ...
      lead_status: ["nuevo", "contactado", "interesado", "cerrado", "descartado"],
      listing_type: ["venta", "arriendo"],
      post_category: ["compra", "venta", "inversion", "consejos", "mercado", "legal", "proyectos"],
      post_status: ["borrador", "publicado", "programado"],
      property_status: ["disponible", "vendido", "arrendado", "reservado"],
      property_type: ["apartamento", "casa", "local", "oficina", "lote", "bodega"],
    },
