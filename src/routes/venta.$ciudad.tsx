...
export const Route = createFileRoute("/venta/$ciudad")({
  ...
  head: ({ params, loaderData }) => {
    ...
    const url = `https://alquidel.com/venta/${city.slug}`;
    const title = `Inmuebles en venta en ${city.label} | Alquidel Bienes Raíces`;
    const description = `Apartamentos, casas, oficinas, locales y bodegas en venta en ${city.label}. Inventario verificado y acompañamiento de un asesor Alquidel.`;
    return {
      meta: [
        { title },
  ...
  component: VentaCiudad,
});

function VentaCiudad() {
  const { city } = Route.useLoaderData();
  return <CityLandingPage city={city} operacion="venta" />;
}
